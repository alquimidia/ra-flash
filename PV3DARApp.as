package {
	...
	public class PV3DARApp extends ARAppBase {
		...
		protected override function onInit():void {
			...
			this._capture.width = 800;
			this._capture.height = 600;
			this._base.addChild(this._capture);
			
			this._viewport = this._base.addChild(new Viewport3D(320, 240)) as Viewport3D;
			this._viewport.scaleX = 800 / 320;
			this._viewport.scaleY = 600 / 240;
		...
		private function _onEnterFrame(e:Event = null):void {
			...
			try {
				detected = this._detector.detectMarkerLite(this._raster, 80) && this._detector.getConfidence() > 0.1;
			} catch (e:Error) {}
